...
s.CHAIN,
null AS OP_HASH
FROM {{ source('unichain_raw', 'traces') }} t
INNER JOIN {{ ref('eip7702_state_base') }} s
ON t.FROM_ADDRESS = s.AUTHORITY
...
INNER JOIN {{ source('unichain_raw', 'transactions') }} tx
